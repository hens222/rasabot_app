...
- כמה [ממתיקים מלאכותיים](food_entity) כדאי לי לצרוך
- כמה [ויטמין סי](nutrient) מומלץ לי לאכול ביום
- כמה [קפה](food_entity) מומלץ לשתות ביום
- כמה [סידן](nutrient) אני צריך לצרוך ביום
- כמה [ביצים](food_entity) כדאי לי ביום
- כמה [קפה](food_entity) כדאי לי לשתות ביום
- כמה [ביצים](food_entity) צריך לאכול ביום
- כמה [ביצים](food_entity) מומלץ לי לאכול
- מה ההמלצה לצריכה של [קפה](food_entity)
- כמה [ביצים](food_entity) אתה ממליץ לי לאכול
- כמה [שתייה ממותקת](food_entity) מומלצת ביום
- כמה [אומגה 3](nutrient) אני אמור לאכול ביום
...
- מה לעשות כדי להוריד את ה[כולסטרול](nutrient)
- כיצד אפשר להוריד [כולסטרול](nutrient)
- איך אני יכול [להעלות מסת שריר](goal_or_state)
- כיצד אוכל [להעלות](goal_or_state) את [מסת השריר](goal_or_state) שלי
- איך אתה ממליץ לי לשפר את ה[כולסטרול](nutrient)
- איך אתה ממליץ לי להוריד [כולסטרול](nutrient) בדם
- כיצד אני יכול לשפר את ה[כולסטרול](nutrient) שלי
...
- איך אפשר לשפר את ה-[HDL](nutrient)
...
- כיצד ניתן להוריד [כולסטרול](nutrient)
- איך אפשר לשפר את ה[כולסטרול](nutrient) בדם
...
- מה לאכול כדי להוריד את ה[כולסטרול](nutrient) שלי
...
- מה ניתן לעשות כדי לחזק את [מערכת החיסון]{"entity": "goal_or_state", "value": "\u05de\u05e2\u05e8\u05db\u05ea \u05d7\u05d9\u05e1\u05d5\u05e0\u05d9\u05ea"}
- מה כדאי לי לעשות כדי לחזק את [המערכת החיסונית]{"entity": "goal_or_state", "value": "\u05de\u05e2\u05e8\u05db\u05ea \u05d7\u05d9\u05e1\u05d5\u05e0\u05d9\u05ea"}
...
- כמה [חלבון](nutrient) יש ב[גביע יוגורט](food_entity)
- כמה [חלבון](nutrient) יש בטונה
...
- האם כדאי לי לשתות הרבה [חלב](food_entity)
...
- מהו הטווח התקין של [כולסטרול](nutrient) עבורי
...
- מה ערך תקין עבורי בבדיקת [כולסטרול](nutrient)
- מה ערך [פריטין](nutrient) תקין עבורי בבדיקת הדם
- כמה זה ערך [פריטין](nutrient) טוב עבורי
- מה רמת ה[ברזל](nutrient) התקינה בדם
- מה רמת [ברזל](nutrient) תקינה בדם
...
- במה ניתן להחליף [פיצה](food_entity)
- אני רוצה להחליף [אורז](food_entity)
- לא רוצה לאכול [לחם](food_entity)
- תציע לי משהו אחר במקום [פסטה](food_entity)
- מה אפשר לאכול במקום [בשר](food_entity) אם אני [צמחוני](nutrition_concept)
- מה אפשר לאכול במקום [מלפפון](food_entity)
- אם אני לא אוהב [מלפפון](food_entity), איך אפשר להחליף
- מה אפשר לאכול במקום [חלב](food_entity)
- באילו דברים אפשר להחליף [פיתה](food_entity)
- אם אני לא אוכל [לחם](food_entity), איך אפשר להחליף
- לא בא לי [ספגטי](food_entity). מה אפשר במקום
...
- איזה מאכל מומלץ כתחליף ל[בצל](food_entity)
- מה תמליץ בתור תחליף ל[חסה](food_entity)
- מה כדאי לאכול במקום [עגבניה](food_entity)
- מה כדאי לאכול במקום [עגבנייה](food_entity)
- מה אפשר לאכול במקום [מנגולד](food_entity)
- מה אפשר לאכול במקום [סלק](food_entity)
- מה תחליף טוב ל[סלק](food_entity)
- מה חלופה [צמחונית](nutrition_concept) טובה ל[המבורגר](food_entity)
- אם אני לא זורם על [פיצה](food_entity), מה תמליץ במקום
- אם לא בא לי לאכול [דג](food_entity), מה אפשר
- מה תמליץ לאכול אם אני לא ממש מת על [דגים](food_entity)
- מה אתה ממליץ לאכול אם אני לא אוהב לאכול [בשר](food_entity)
- מה לאכול אם לא מתחשק לי לאכול [ביצה](food_entity)
- מה אפשר לאכול אם לא בא לי על [תפוח אדמה](food_entity)
- מה אפשר לאכול אם אני לא אוהב [חסה](food_entity)
- מה אפשר לאכול במקום לאכול [שקדים](food_entity)
- מה יכול להיות תחליף ראוי ל[שקדים](food_entity)
...
- איזה שאלות, למשל
- איזה סוג
- תסביר לי מה אפשר לשאול אותך
- תן לי דוגמאות לדברים שאפשר לשאול אותך
- איזה סוג של שאלות אני יכול לשאול אותך
- אילו שאלות אפשר לשאול אותך
- על איזה שאלות אתה יודע לענות בדיוק, ניוט
...
- מה כדאי לאכול לפני [ריצה](training_type)
- מה אתה ממליץ לאכול לפני [אימון ריצה](training_type)
- מה עדיף לאכול לפני [אימון ריצה](training_type)
- מה אתה ממליץ לאכול לפני [ריצה](training_type)
- מה אתה ממליץ לאכול לפני [אימון אירובי](training_type)
- מה כדאי לאכול לפני [שינה](goal_or_state)
- מה כדאי לאכול לפני ה[שינה](training_type)
- אילו דברים כדאי לאכול לפני [ריצה](training_type)
- מה אתה ממליץ לפני [ריצה](training_type)
- מה צריך לאכול לפני [אימון כוח](training_type)
- מה כדאי לי לאכול לפני [ריצה](training_type)
- מה עלי לאכול לפני [ריצה](training_type)
- מה כדאי לי לאכול לפני ה[שינה](goal_or_state)
- מה תמליץ לאכול לפני ה[שינה](goal_or_state)
- מה תמליץ לי לאכול לפני [אימון](training_type)
- מה תמליץ לי לאכול לפני [אימון טניס](training_type)
- מה לאכול לפני [אימון פילטיס](training_type)
- מה לדעתך צריך לאכול לפני [אימון כוח](training_type)
- מה כדאי לי לאכול לפני [אימון משקולות](training_type)
- מה לאכול כדי להתכונן ל[אימון רכיבה על אופניים](training_type)
- מה אתה ממליץ לי לצרוך לפני [אימון שחייה](training_type)
- מה מומלץ לאכול לפני [אימון ריצה](training_type)
- מה אפשר לאכול קצת לפני [אימון פילאטיס](training_type)
- מה אתה ממליץ לאכול בקטנה לפני [אימון יוגה](training_type)
- מה לאכול לפני סשן של [מתיחות](training_type)
- מה תמליץ לי לאכול לפני [רכיבת אופניים ארוכה](training_type) מאוד
...
- מה מומלץ לאכול אחרי [ריצה](training_type)
- מה אתה ממליץ לי לאכול אחרי [ריצה](training_type)
- אילו דברים כדאי לאכול אחרי [ריצה](training_type)
- מה לדעתך צריך לאכול אחרי ה[שינה](goal_or_state)
- מה לאכול אחרי [ריצה](training_type)
- מה כדאי לי לאכול אחרי [ריצה](training_type)
- מה עלי לאוכל אחרי [ריצה](training_type)
- יש לך המלצה לגבי מה לאכול אחרי [אימון ריצה](training_type)
- מה דברים שטוב לאכול אחרי [ריצה](training_type)
- מה כדאי לי לאכול אחרי [אימון כדורגל](training_type)
- מה כדאי לאכול אחרי [אימון שחייה](training_type)
- מה מועיל לאכול אחרי [שחייה](training_type)
- מה לאכול אחרי [פילטיס](training_type)
- מה לאכול אחרי [אימון יוגה](training_type)
- מה לאכול אחרי [אימון כדורגל](training_type)
- מה לאכול אחרי [אימון כדורסל](training_type)
- מה לאכול אחרי [רכיבה ארוכה על אופניים](training_type)
- מה לאכול אחרי [רכיבה על אופניים](training_type)
- מה תמליץ לאכול לאחר [אימון כח](training_type)
- מה היית ממליץ לצרוך לאחר [אימון כדורסל](training_type)
- אילו מאכלים כדאי לאכול לאחר [אימון טניס](training_type)
- מה הכי טוב לצרוך כדי להתאושש אחרי [מרתון](training_type)
- מה הכי טוב לאכול כדי להתאושש מ[רכיבה ארוכה](training_type)
- מה לאכול מיד אחרי [אימון משקולות](training_type)
- מה אתה ממליץ לאכול מיד אחרי ה[שינה](goal_or_state)
- מה לאכול כשאני [מתעורר](goal_or_state)
- מה צריך לצרוך כדי להתאושש לאחר [מאמץ אירובי ממושך](training_type) מאוד
- מה תמליץ לי לאכול אחרי [מאמץ אירובי ארוך](training_type)
...
- כיצד אוכל להמנע מעלייה ב[כולסטרול](nutrient)
...
- מה אוכל לעשות כדי לא [להשמין](goal_or_state)[להשמין]{"entity": "goal_or_state", "value": "\u05d4\u05e9\u05de\u05e0\u05d4"}
- כיצד אפשר להמנע מהשמנה
- מה לעשות כדי לא [להשמין]{"entity": "goal_or_state", "value": "\u05d4\u05e9\u05de\u05e0\u05d4"}
- איך תמליץ לי לא [להשמין](goal_or_state)[להשמין]{"entity": "goal_or_state", "value": "\u05d4\u05e9\u05de\u05e0\u05d4"}
- מה לאכול כדי לא [להשמין]{"entity": "goal_or_state", "value": "\u05d4\u05e9\u05de\u05e0\u05d4"}[להשמין](goal_or_state)

## intent:nutrition_what_impacts
- מה משפיע על ה[משקל](nutrition_concept) שלי
...
- אמרו לי ש[צמחונות](nutrition_concept) זה טוב. מה אתה חושב
...
- כמה [מלח](nutrient) מותר לי לצרוך
- כמה [מתוק](food_entity) מותר לי לאכול ביום
- כמה [מסטיקים](food_entity) מותר לי לאכול ביום אחד
- כמה כוסות [חלב](food_entity) מותר לי לשתות ביום
- כמה [קפה](food_entity) אפשר לשתות ביום
- האם כדאי לי להגביל את כמות ה[מתוקים](food_entity)
- האם כדאי לי להגביל את כמות ה[מלח](food_entity) שאני אוכל
- האם אני מוגבל בכמות ה[ממתיקים המלאכותיים](food_entity) שמותר לי לאכול
- האם יש הגבלה על כמות ה[מסטיקים](food_entity) שמותר לי
- האם יש מגבלה לכמות ה[קפה](food_entity) שמותר לי לצרוך ביום
- האם יש מגבלה לכמות ה[עוגה](food_entity) שאני יכול לאכול ביום
- כמה [ויטמין סי](nutrient) מותר לי לצרוך
- כמה [סידן](nutrient) מותר לי לצרוך ביום אחד
- כמה [סידן](nutrient) מותר לי לצרוך ביום
- כמה [סידן](nutrient) מותר לי לצרוך
- מה הכמות המקסימלית של [ויטמין סי](nutrient) שמותר לי לצרוך
- כמה הכי הרבה [ביצים](food_entity) אני יכול לאכול ביום
- כמה הכי הרבה [ביצים](food_entity) אפשר לאכול ביום
- מה הכמות המקסימלית של [ביצים](food_entity) שאני יכול לצרוך ביום אחד
- כמה [קפה](food_entity) אני יכול לשתות ביום
- מה הכמות המקסימלית של [ביצים](food_entity) שמותר לי לאכול ביום
- כמה [קולה](food_entity) אתה חושב שאני יכול לשתות ביום
- כמה [מיץ](food_entity) אפשר לשתות
- כמה [מלח](nutrient) מותר לי לאכול
- כמה [ממתקים](food_entity) אתה מוכן שאני אוכל ביום
...
- למה בודקים [כולסטרול](nutrient) בדם
- מה מלמדת אותנו בדיקת [כולסטרול](nutrient)
- מה מראה בדיקת [כולסטרול](nutrient) בדם
- מה המשמעות של בדיקת [טריגליצרידים](nutrient)
- מה בודקת בדיקת [HDL](nutrient)
- מה בודקת בדיקת דם של [LDL](nutrient)
- מה אומרת בדיקת [LDL](nutrient) בדם
- מה זה בדיקת דם של [כולסטרול](nutrient)
- מה זו בדיקת דם של [פריטין](nutrient)
- מה בודקת בדיקת [ברזל](nutrient) בדם
- מהי בדיקת [טריגליצרידים](nutrient)
- מה זה בדיקת [אשלגן](nutrient)
- מה זה בדיקת [נתרן](nutrient) בדם
- למה כדאי לי לעשות בדיקת [סידן](nutrient) בדם
- למה עושים בדיקת [סידן](nutrient) בדם
- עבור מה עושים בדיקת [סידן](nutrient)
- למה זה חשוב לבצע בדיקת [ברזל](nutrient)
- למה כדאי לעשות בדיקת [ברזל](nutrient) בדם
- האם כדאי לבדוק את ה[ברזל](nutrient) בדם
- האם מומלץ לבצע בדיקת [טריגליצרידים](nutrient)
- מה זה אומר בדיוק בדיקת [כלוריד](nutrient)
- מה זה בדיקת [כלור](nutrient)
- מהי בדיקת [פריטין](nutrient)
- מה זה בדיקת [A1C](nutrient)
- מה זה בדיקת [סידן](nutrient)
...
- מה לעשות אם ערך ה[כולסטרול](nutrient) שלי גבוה מדי
- מה לעשות אם יש [פריטין](nutrient) גבוה
- מה לעשות אם הבדיקה של [כלור](nutrient) בדם יצאה לי גבוה מהנדרש
- מה לעשות אם יצא לי [פריטין](nutrient) גבוה
- מה לעשות אם ה[כלור](nutrient) יצא לי גבוה
- מה לעשות אם הבדיקה של [כלור](nutrient) בדם יצאה גבוה מהסף
- מה לעשות אם בדיקת ה[כלור](nutrient) גבוהה מדי
- מה אתה ממליץ למקרה שבדיקת [כלור](nutrient) גבוהה מהרצוי
- מה ההמלצה לערך בדיקה [פריטין](nutrient) גבוה
- מה ההמלצה אם יש לי ערך גבוה מדי בבדיקת [פריטין](nutrient)
- מה אתה ממליץ אם יש לי ערך [כולסטרול](nutrient) גבוה מדי בבדיקות הדם שלי

## intent:nutrition_bloodtest_whatif_toolow
- מה לעשות אם ערך בדיקת ה[כולסטרול](nutrient) שלי נמוך מדי
- מה לעשות אם יצא לי [ברזל](nutrient) נמוך
- מה עושים אם ה[פריטין](nutrient) שלי נמוך
- מה זה אומר אם ערך ה[סידן](nutrient) בבדיקה יצא נמוך מדי
- מה זה אומר אם יצא לי [כלור](nutrient) נמוך בבדיקת הדם
- מה לעשות אם יש לי [ברזל](nutrient) נמוך בבדיקות הדם
- מה לעשות אם ה[פריטין](nutrient) שלי נמוך
